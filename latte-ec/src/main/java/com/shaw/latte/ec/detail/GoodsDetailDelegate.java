...
import com.shaw.latte.ui.banner.HolderCreator;
import com.shaw.latte.ui.widget.CircleTextView;
...
public class GoodsDetailDelegate extends LatteDelegate implements AppBarLayout.OnOffsetChangedListener {
    ...
    public static GoodsDetailDelegate create(@NonNull int goodId) {
