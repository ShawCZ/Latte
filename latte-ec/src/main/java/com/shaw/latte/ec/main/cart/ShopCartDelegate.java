...
import com.shaw.latte.ec.pay.FastPay;
import com.shaw.latte.ec.pay.IAlPayResultListener;
...
public class ShopCartDelegate extends BottomItemDelegate implements ISuccess, ICartItemListener, IAlPayResultListener {
    ...
    void onClickSelected() {
        //全选图标 默认的tag为0，表示未被选中；
        final int tag = (int) mIconSelectAll.getTag();
        if (tag == 0) {
            //全选图标被选中，设置颜色，设置tag为1；
    ...
    private void createOrder() {
        final String orderUrl = "生成订单的API";
