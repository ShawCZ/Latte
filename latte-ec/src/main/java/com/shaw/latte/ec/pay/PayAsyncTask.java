...
public class PayAsyncTask extends AsyncTask<String, Void, String> {
    ...
    //订单处理中
    private static final String AL_PAY_STATUS_PATING = "8000";
    //订单支付失败
    private static final String AL_PAY_STATUS_FAIL = "4000";
    //用户取消
    private static final String AL_PAY_STATUS_CANCLE = "6001";
    //订单支付成功
